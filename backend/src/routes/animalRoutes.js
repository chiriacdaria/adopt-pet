...
const { createAnimal, getAnimalById, updateAnimal, getAllAnimals, deleteAnimal, getAdoptedAnimalsByUser, getHomelessAnimals } = require('../controllers/animalController');
...
router.get('/animals/homeless', authenticate, getHomelessAnimals);
